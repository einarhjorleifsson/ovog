...
jpth <- "C:/Users/einarhj/Downloads/A3-2024.zip"
tmpdir <- tempdir()
unzip(jpth, exdir = tmpdir)
dir(tmpdir)
...
res <- list(st = st, nu = nu, le = le, kv = kv, skraning = skraning,
...
res |> readr::write_rds("data2/hafvog.rds")
...
hafvog:::munge_for_smxapp_hafvog(res, cruise = c("A3-2024"))
```
