...
```{r, eval = FALSE}
res <- hv_read_hafvog(zipfiles = "A7-2024.zip")
```

For the document in this document we will download a zip file from hafro ftp-site: 
...
To access e.g. the "numer" file one does:
